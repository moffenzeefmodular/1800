...
#include "AudioSampleRim2.h"
#include "AudioSampleSnare.h"
#include "AudioSampleSnare2.h"
#include "AudioSampleTomfx.h"
...
void loop() {
  ...
  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleRim); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleRim2); // Play sound
  }
  ...
  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleTomfx); // Play sound
  }
