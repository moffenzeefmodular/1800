...
#include "AudioSampleAxxehc2.h"
#include "AudioSampleAxxehc3.h"
#include "AudioSampleAxxehhc1.h"
#include "AudioSampleAxxehhc2.h"
#include "AudioSampleAxxehho1.h"
#include "AudioSampleAxxehho2.h"
#include "AudioSampleAxxekick2.h"
#include "AudioSampleAxxekick3.h"
#include "AudioSampleAxxekick4.h"
#include "AudioSampleAxxesn1.h"
#include "AudioSampleAxxesn2.h"
#include "AudioSampleAxxesn3.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleAxxekick2); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleAxxekick3); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleAxxekick4); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleAxxesn1); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleAxxesn2); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleAxxesn3); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleAxxehc2); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleAxxehc3); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleAxxehhc1); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleAxxehhc2); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleAxxehho1); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleAxxehho2); // Play sound
  }
