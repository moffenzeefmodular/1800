...
#include "AudioSampleCbrz.h"
#include "AudioSampleCcrz.h"
#include "AudioSampleClrz.h"
#include "AudioSampleCrrz.h"
#include "AudioSampleHcrz.h"
#include "AudioSampleHorz.h"
#include "AudioSampleKirz.h"
#include "AudioSampleRsrz.h"
#include "AudioSampleSnrz.h"
#include "AudioSampleTm1rz.h"
#include "AudioSampleTm2rz.h"
#include "AudioSampleTm3rz.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleKirz); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleSnrz); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleRsrz); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleHcrz); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleHorz); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleClrz); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleTm1rz); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleTm2rz); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleTm3rz); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleCcrz); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleCrrz); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleCbrz); // Play sound
  }
