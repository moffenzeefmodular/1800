...
#include "AudioSampleS78bdrum.h"
#include "AudioSampleS78chh.h"
#include "AudioSampleS78clave.h"
#include "AudioSampleS78cow.h"
#include "AudioSampleS78guiro1.h"
#include "AudioSampleS78guiro2.h"
#include "AudioSampleS78ohh.h"
#include "AudioSampleS78shaker.h"
#include "AudioSampleS78snare.h"
#include "AudioSampleS78tom1.h"
#include "AudioSampleS78tom2.h"
#include "AudioSampleS78tom3.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleS78bdrum); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleS78snare); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleS78chh); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleS78ohh); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleS78tom1); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleS78tom2); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleS78tom3); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleS78clave); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleS78shaker); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleS78cow); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleS78guiro1); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleS78guiro2); // Play sound
  }
