...
#include "AudioSampleHh5.h"
#include "AudioSampleSd2.h"
#include "AudioSampleSdclp1.h"
#include "AudioSampleSdrim1.h"
...
void loop() {
  ...
  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleSd2); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleSdclp1); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleSdrim1); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleTom1); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleTom2); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleHh1); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleHh2); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleHh3); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleHh4); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleHh5); // Play sound
  }
