...
#include "AudioSampleBell1.h"
#include "AudioSampleBell2.h"
#include "AudioSampleBlock.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleSnare1); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleSnare2); // Play sound
  }
  ...
  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleBlock); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleConga); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSamplePerc1); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSamplePerc2); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleSnap); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleShaker); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleBell1); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleBell2); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleCowbell); // Play sound
  }
