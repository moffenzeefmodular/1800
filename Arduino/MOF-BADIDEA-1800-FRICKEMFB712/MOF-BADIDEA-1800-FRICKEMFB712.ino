...
#include "AudioSampleMfb1rim.h"
#include "AudioSampleMfb1tom.h"
#include "AudioSampleMfb2rim.h"
#include "AudioSampleMfb3tom.h"
#include "AudioSampleMfb4tom.h"
#include "AudioSampleMfbbd1.h"
#include "AudioSampleMfbbd2.h"
#include "AudioSampleMfbbong.h"
#include "AudioSampleMfbhhc.h"
#include "AudioSampleMfbhhcl.h"
#include "AudioSampleMfbhhop.h"
#include "AudioSampleMfbsn.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleMfbbd1); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleMfbbd2); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleMfbsn); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleMfb1rim); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleMfb2rim); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleMfbbong); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleMfbhhc); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleMfbhhcl); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleMfbhhop); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleMfb1tom); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleMfb3tom); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleMfb4tom); // Play sound
  }
