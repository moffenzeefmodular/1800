...
#include "AudioSampleR50bd3.h"
#include "AudioSampleR50clap1.h"
#include "AudioSampleR50clap2.h"
#include "AudioSampleR50click.h"
#include "AudioSampleR50elec.h"
#include "AudioSampleR50etomh.h"
#include "AudioSampleR50etoml.h"
#include "AudioSampleR50etomm.h"
#include "AudioSampleR50hatc1.h"
#include "AudioSampleR50hato1.h"
#include "AudioSampleR50rim.h"
#include "AudioSampleR50snap.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleR50bd3); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleR50clap1); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleR50clap2); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleR50click); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleR50snap); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleR50rim); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleR50elec); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleR50hatc1); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleR50hato1); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleR50etoml); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleR50etomm); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleR50etomh); // Play sound
  }
