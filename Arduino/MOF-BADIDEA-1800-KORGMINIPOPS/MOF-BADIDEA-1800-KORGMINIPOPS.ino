...
#include "AudioSampleBd1.h"
#include "AudioSampleBd2.h"
#include "AudioSampleBd3.h"
#include "AudioSampleHihat1.h"
#include "AudioSampleHihat2.h"
#include "AudioSampleSd1.h"
#include "AudioSampleSd2.h"
#include "AudioSampleSd3.h"
#include "AudioSampleSdfx.h"
#include "AudioSampleTom1.h"
#include "AudioSampleWood1.h"
#include "AudioSampleWood2.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleBd1); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleBd2); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleBd3); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleSd1); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleSd2); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleSd3); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleSdfx); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleWood1); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleWood2); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleTom1); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleHihat1); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleHihat2); // Play sound
  }
