...
#include "AudioSampleLm1cabasa.h"
#include "AudioSampleLm1chh.h"
#include "AudioSampleLm1clap.h"
#include "AudioSampleLm1conga.h"
#include "AudioSampleLm1congal.h"
#include "AudioSampleLm1cowb.h"
#include "AudioSampleLm1hitom.h"
#include "AudioSampleLm1kick1.h"
#include "AudioSampleLm1ohh.h"
#include "AudioSampleLm1sd1.h"
#include "AudioSampleLm1sst.h"
#include "AudioSampleLm1tamb.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleLm1kick1); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleLm1sd1); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleLm1clap); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleLm1sst); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleLm1cabasa); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleLm1chh); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleLm1ohh); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleLm1hitom); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleLm1conga); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleLm1congal); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleLm1cowb); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleLm1tamb); // Play sound
  }
