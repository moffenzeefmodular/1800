...
#include "AudioSampleHhcl.h"
#include "AudioSampleHhop.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleKick1); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleSnare1); // Play sound
  }
  ...
  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleHhcl); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleHhop); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleClave); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSamplePerc1); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSamplePerc2); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSamplePerc3); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSamplePerc4); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSamplePerc5); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSamplePerc6); // Play sound
  }
