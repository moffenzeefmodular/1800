...
#include "AudioSampleHatwa.h"
#include "AudioSampleHhc.h"
#include "AudioSampleHho.h"
#include "AudioSampleKick.h"
#include "AudioSampleKickwa.h"
#include "AudioSampleRimwa.h"
#include "AudioSampleSnare.h"
#include "AudioSampleSnarewa.h"
...
void loop() {
  ...
  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleKickwa); // Play sound
  }
  ...
  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleSnarewa); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleRimwa); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleHatwa); // Play sound
  }
  ...
  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleTomm); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleTomh); // Play sound
  }
