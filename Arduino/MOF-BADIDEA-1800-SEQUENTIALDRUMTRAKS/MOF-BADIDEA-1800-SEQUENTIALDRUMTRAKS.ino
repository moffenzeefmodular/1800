...
#include "AudioSampleDtcabasa.h"
#include "AudioSampleDtclap.h"
#include "AudioSampleDtclosedhat.h"
#include "AudioSampleDtcowbell.h"
#include "AudioSampleDtkick.h"
#include "AudioSampleDtopenhat.h"
#include "AudioSampleDtride.h"
#include "AudioSampleDtrimshot.h"
#include "AudioSampleDtsnare.h"
#include "AudioSampleDttamborine.h"
#include "AudioSampleDttom01.h"
#include "AudioSampleDttom02.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleDtkick); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleDtsnare); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleDtclap); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleDtrimshot); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleDtcabasa); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleDtclosedhat); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleDtopenhat); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleDttom01); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleDttom02); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleDtcowbell); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleDttamborine); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleDtride); // Play sound
  }
