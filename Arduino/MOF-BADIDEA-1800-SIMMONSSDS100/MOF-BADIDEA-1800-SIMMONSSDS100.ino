...
#include "AudioSampleSdsk1.h"
#include "AudioSampleSdss1.h"
#include "AudioSampleSdss2.h"
#include "AudioSampleSdss3.h"
#include "AudioSampleSdss4.h"
#include "AudioSampleSdss5.h"
#include "AudioSampleSdss6.h"
#include "AudioSampleSdss7.h"
#include "AudioSampleSdss8.h"
#include "AudioSampleSdst1.h"
#include "AudioSampleSdst2.h"
#include "AudioSampleSdst3.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleSdsk1); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleSdss1); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleSdss2); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleSdss3); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleSdss4); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleSdss5); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleSdss6); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleSdss7); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleSdss8); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleSdst1); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleSdst2); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleSdst3); // Play sound
  }
