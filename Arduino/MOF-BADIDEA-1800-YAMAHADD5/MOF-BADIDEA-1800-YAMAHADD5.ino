...
#include "AudioSampleYdd5clap.h"
#include "AudioSampleYdd5conga.h"
#include "AudioSampleYdd5cowbell.h"
#include "AudioSampleYdd5cym.h"
#include "AudioSampleYdd5hhcl.h"
#include "AudioSampleYdd5hhop.h"
#include "AudioSampleYdd5kick.h"
#include "AudioSampleYdd5rim.h"
#include "AudioSampleYdd5snare.h"
#include "AudioSampleYdd5tom1hi.h"
#include "AudioSampleYdd5tom2mi.h"
#include "AudioSampleYdd5tom3lo.h"
...
void loop() {
  ...
  if (currentState1 < lastState1) {
    playMem1.play(AudioSampleYdd5kick); // Play sound
  }

  if (currentState2 < lastState2) {
    playMem2.play(AudioSampleYdd5snare); // Play sound
  }

  if (currentState3 < lastState3) {
    playMem3.play(AudioSampleYdd5clap); // Play sound
  }

  if (currentState4 < lastState4) {
    playMem4.play(AudioSampleYdd5rim); // Play sound
  }

  if (currentState5 < lastState5) {
    playMem5.play(AudioSampleYdd5hhcl); // Play sound
  }

  if (currentState6 < lastState6) {
    playMem6.play(AudioSampleYdd5hhop); // Play sound
  }

  if (currentState7 < lastState7) {
    playMem7.play(AudioSampleYdd5conga); // Play sound
  }

  if (currentState8 < lastState8) {
    playMem8.play(AudioSampleYdd5tom3lo); // Play sound
  }

  if (currentState9 < lastState9) {
    playMem9.play(AudioSampleYdd5tom2mi); // Play sound
  }

  if (currentState10 < lastState10) {
    playMem10.play(AudioSampleYdd5tom1hi); // Play sound
  }

  if (currentState11 < lastState11) {
    playMem11.play(AudioSampleYdd5cowbell); // Play sound
  }

  if (currentState12 < lastState12) {
    playMem12.play(AudioSampleYdd5cym); // Play sound
  }
